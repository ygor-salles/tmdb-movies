  ...
  return (
    <>
      <div
        ...
        className="w-72 relative rounded-lg overflow-hidden shadow-lg bg-zinc-900 dark:bg-zinc-900 transition-transform duration-300 hover:scale-105 hover:shadow-lg cursor-pointer"
      >
        <img
